...
_TYPE_AUTO_EXCEPTIONS: dict[str, set[str]] = {
    "shared-library": {
        "CD-002", "CD-009", "CD-010",
        "PY-006",
        "TEST-001", "TEST-002", "TEST-003", "TEST-004",
        "PIPE-001", "PIPE-002", "PIPE-003", "PIPE-004", "PIPE-005",
        "PIPE-006", "PIPE-007", "PIPE-008", "PIPE-009", "PIPE-011",
        "PIPE-012", "CD-007", "CD-015",
        "XSTACK-001",
    },
    "static-site": {
        "CD-002", "CD-009", "CD-010",
...
class EvaluatorConfig:
    ...
    def language(self) -> str:
        ...
        if self.repo_type in ("pipeline-cog", "trigger-cog", "api-service", "shared-library", "standards-repo"):
